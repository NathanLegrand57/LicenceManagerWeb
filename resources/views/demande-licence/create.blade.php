<x-app-layout>
    ...
    @if (session('demandeAjout'))
        ...
        <div class="flex justify-center mt-8">
            <div class="w-4/12 text-md bg-white p-6 mt-6 rounded-lg shadow-md leading-8">
                <p class="text-gray-700"><strong>Libellé de la licence :</strong> {{ $demandeAjout->libelle }}</p>
                @if ($demandeAjout->duree > 31)
                    <h5><strong>Licence annuelle</strong></h5>
                @else
                    <h5><strong>Licence mensuelle</strong></h5>
                @endif
                <p class="text-gray-700"><strong>Produit :</strong> {{ $demandeAjout->produit }}</p>
    ...
    @if (Session::has('success'))
        <div class="flex h-60">
            <div class="text-green-500 text-center m-auto">
                ...
                <p class="text-gray-700">Vous allez être redirigé vers la liste de vos licences dans quelques secondes
                </p>
            </div>
        </div>
        <script>
